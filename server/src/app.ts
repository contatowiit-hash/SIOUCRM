...
export const buildApp = async () => {
  ...
  await app.register(cors, {
    ...
    allowedHeaders: ['authorization', 'content-type', 'x-webhook-signature', 'x-hub-signature-256', 'x-timestamp', 'x-signature', 'x-request-id', 'x-integration-token', 'x-provider-token'],
    maxAge: 600,
